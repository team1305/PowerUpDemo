...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        // Program 1
        Constants.add("PL1C1", "D48"); // DR0D48
        Constants.add("PL1C2", "R90");
        Constants.add("PL1C3", "D96");
        Constants.add("PL1C4", "R-90");
        Constants.add("PL1C5", "AUP");
        Constants.add("PL1C6", "P0.2");
        Constants.add("PL1C7", "");
        Constants.add("PL1C8", "");
        Constants.add("PL1C9", "");
        Constants.add("PL1C10", "");

        Constants.add("PR1C1", "D48");
        Constants.add("PR1C2", "R90");
        Constants.add("PR1C3", "D96");
        Constants.add("PR1C4", "R-90");
        Constants.add("PR1C5", "AUP");
        Constants.add("PR1C6", "P0.2");
        Constants.add("PR1C7", "");
        Constants.add("PR1C8", "");
        Constants.add("PR1C9", "");
        ...
        // Program 2
        Constants.add("PL2C1", "D48");
        Constants.add("PL2C2", "P0.4");
        Constants.add("PL2C3", "");
        Constants.add("PL2C4", "");
        Constants.add("PL2C5", "");
        Constants.add("PL2C6", "");
        ...
        Constants.add("PR2C1", "D48");
        Constants.add("PR2C2", "R90");
        Constants.add("PR2C3", "D96");
        Constants.add("PR2C4", "R-90");
        Constants.add("PR2C5", "AUP");
        Constants.add("PR2C6", "P0.2");
        Constants.add("PR2C7", "");
        Constants.add("PR2C8", "");
        Constants.add("PR2C9", "");
